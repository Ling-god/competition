...
for i in range(epochs):
    ...
    writer.add_scalar("loss2",total_test_loss,step)
    writer.add_scalar("accuracy1",total_accuracy/test_data_size,step)
    step+=1

    torch.save(fs.state_dict(),"model_comp_color.pth")
    print("已保存")
